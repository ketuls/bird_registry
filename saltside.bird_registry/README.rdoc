...
3) Clone the repo: https://github.com/ketuls/bird_registry and cd saltside.bird_registry

5) bundle install

6) rails s -p 3000

7) Test the api's. We can use Advanced Rest Client, Postman or any other tools to test the api's.
    Refer:https://chrome.google.com/webstore/detail/advanced-rest-client/hgmloofddffdnphfgcellkdfbfbjeloo
...
TODO:
1) Write Test cases.
2) Better Documentation.(Add Developer Documentation)
3) Query Performance Optimization.
4) Load testing.
5) Remove nested directory for repo.
